...
data class SuccessGetGitHubRepoListState(override val response: Response.Success<List<GitHubRepo>>) : GetGitHubRepoListState()
data class LoadingGetGitHubRepoListState(override val response: Response<List<GitHubRepo>>? = null) : GetGitHubRepoListState()
data class ErrorGetGitHubRepoListState(override val response: Response.Error) : GetGitHubRepoListState()
